  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 -left-32 w-96 h-96 bg-neon/5 rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        <p className="text-center text-sm text-text-muted mt-6">
          No tenes cuenta?{' '}
          <Link href="/auth/register" className="text-neon hover:underline font-medium">
            Registrate
          </Link>
        </p>
      </motion.div>
